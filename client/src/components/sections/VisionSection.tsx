  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none">
        ...
        >
          <div className="w-full h-full bg-gradient-radial from-cyan-500/10 via-blue-500/5 to-transparent blur-3xl" />
        </motion.div>
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="section-title font-outfit text-3xl md:text-4xl lg:text-5xl font-semibold text-white/90 mb-8 leading-tight">
            ...
            <span className="text-blue-400"> speed</span> and 
        ...
        >
          ...
          <span className="text-cyan-400/80 text-sm tracking-[0.3em] uppercase mb-6 block">
          ...
          <p className="text-xl md:text-2xl text-white/60 leading-relaxed">
            ...
            A <span className="text-blue-400">guardian</span>. 
