    ...
    >
      ...
      >
        ...
        <div className="relative">
          <div className="absolute left-[31px] md:left-1/2 md:-translate-x-[1px] top-0 bottom-0 w-[2px] bg-gradient-to-b from-cyan-500/80 via-blue-500/50 to-transparent" />
                      ...
                      <div className={`p-5 rounded-xl border transition-all duration-300 ${
                        ...
                        <div className="flex items-center justify-end gap-3 mb-2">
                          <span className={`text-sm font-mono ${
                            milestone.status === 'in_progress' ? 'text-cyan-400' : 'text-white/60'
                          }`}>
                            {milestone.date}
                          </span>
                          {milestone.status === 'in_progress' && (
                        ...
                        <p className="text-sm text-white/50 mb-3">{milestone.description}</p>
